...
def cmd_install(args):
    ...
    from local.ecosystem.installer import EcosystemInstaller
...
def cmd_login(args):
    ...
    from local.wizard.config_wizard import ConfigWizard
    wizard = ConfigWizard()
...
def cmd_status(args):
    ...
    try:
        from local.exoskeleton_daemon import ExoskeletonDaemon
