...
from local.exoskeleton.registry import ModuleRegistry
from local.exoskeleton.stats import CycleStats
from local.exoskeleton.layer_runner import LayerRunner
...
class ExoskeletonDaemon:
    ...
    def _register_modules(self):
        mods = {
            ...
            "adaptive_controller":  lambda: __import__("exoskeleton.layer2.adaptive_controller",fromlist=["AdaptiveController"]).AdaptiveController(),
            ...
            "orchestration_engine": lambda: __import__("exoskeleton.layer3.orchestration_engine",fromlist=["OrchestrationEngine"]).OrchestrationEngine(),
            ...
            "swarm_engine":         lambda: __import__("exoskeleton.layer4.swarm_engine",fromlist=["SwarmEngine"]).SwarmEngine(),
