...
from local.compiler.layer2.feedback_loop import FeedbackControlLoop
from local.compiler.layer2.strategy import StrategySwitcher
...
class SelfRepairEngine:
    ...
    try:
        from local.compiler.layer2.robust_controller import RobustController
    ...
    def detect_issues(self) -> List[dict]:
        ...
        from local.compiler.layer1.health_check import HealthChecker
        hc = HealthChecker()
